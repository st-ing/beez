...
import BeeAvatar1 from '@BeesImages/avatars/1.jpg';
import BeeAvatar2 from '@BeesImages/avatars/2.jpg';
import BeeAvatar3 from '@BeesImages/avatars/3.jpg';
              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                ...
                <tbody>
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={BeeAvatar1} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={BeeAvatar2} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={BeeAvatar3} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={BeeAvatar4} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={BeeAvatar5} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                        <span className="c-avatar-status bg-success"></span>
                      </div>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={BeeAvatar6} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                        <span className="c-avatar-status bg-danger"></span>
                      </div>
                    </td>
                    <td>
